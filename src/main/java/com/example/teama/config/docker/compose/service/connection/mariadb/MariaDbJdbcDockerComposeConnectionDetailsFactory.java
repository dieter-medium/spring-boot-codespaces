...
package com.example.teama.config.docker.compose.service.connection.mariadb;
 ...
 */
public class MariaDbJdbcDockerComposeConnectionDetailsFactory extends DockerComposeConnectionDetailsFactory<JdbcConnectionDetails> {

    private static final String[] MARIADB_CONTAINER_NAMES = {"mariadb", "bitnami/mariadb"};

    public MariaDbJdbcDockerComposeConnectionDetailsFactory() {
     ...
     */
    public static class MariaDbJdbcDockerComposeConnectionDetails extends DockerComposeConnectionDetails
